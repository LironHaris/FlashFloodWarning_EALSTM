...
* **Catchment Sampling**: Each batch contains random samples from various basins. This forces the model to learn a global hydrological mapping instead of overfitting to the behavior of a single river.
